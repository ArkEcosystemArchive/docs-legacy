---
title: "TL:DR examples"
---

The code sections below are simple examples of `client` and `crypto` libraries usage for the specified programming languages. Example functionality consists of:
- importing/loading the needed dependecies/libraries
- intitialisation of the client and connecting to an ark-node(peer)
- retrieve a specific block via API
- create transaction payload
- post transsaction payload to an ark-node(peer)
- handle response data from API

Please reffer to the code comments or check more detailed documentation for specific SDK in the left menu.
